...
`PROJECT_PS.md` (spec) · `RESEARCH_UPGRADES.md` (literature→plan) · `docs/DECISIONS.md` (D01–D14) · `docs/EXPERIMENTS.md` (E01–E06 + failure logs) · `docs/figures/` (7 PNGs) · `models/` (pkl + metrics/eval/ablation/slice/conformal/real JSON) · `tests/` (17 tests) · `.opencode/skills/` (12 vetted skills).
